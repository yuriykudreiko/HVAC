...
class HeatFloorCalculationResultViewController: UIViewController, HeatFloorCalculationViewControllerDelegate {
    ...
    override func viewDidLoad() {
        ...
        navigationItem.title = "Рассчет внутрипольного отопления"
        navigationItem.leftBarButtonItem = UIBarButtonItem(title: "Назад", style: .done, target: self, action: #selector(backAction))
        print("ViewDidLoad")
        layoutSetup()
    }
